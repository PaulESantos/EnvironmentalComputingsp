...
| *cursiva* | *cursiva* |
| **negrita** | **negrita** |
| Insertar una imagen: | ![](E_C_logo_black_square.png) |
| Insertar un enlace: Más ayuda en Environmental Computing-/.. | Más ayuda en [Environmental Computing](/..) |

## Control del comportamiento de los chunk de código

Puedes controlar cómo se muestra el código y su resultado en el documento exportado con una serie de opciones para cada chunk. Hay muchas de estas opciones (detalladas [aquí](https://yihui.name/knitr/options/)), pero algunas útiles son:
