...
Primero, instala la última versión de **R** - descárgala desde [aquí](http://cran.rstudio.com/).
Segundo, instala la última versión de **R Studio** - descárgala desde [aquí](http://www.rstudio.com/products/rstudio/download/).
